...
#     r"C:\Users\HP\OneDrive\Documents\Codes\python\ResearchRaw\ColouredNoise\extractNoise",
#     f".\extractNoise_{timestamp}"
# )
...
# script_content = """<Place your code here for a saved copy>"""
# script_filename = os.path.join(output_folder, "script_copy.py")
