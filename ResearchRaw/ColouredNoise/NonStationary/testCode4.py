...
# Plot noise signals and save the plot
...
plt.legend()
noise_plot_path = os.path.join(directory, 'noise_signals_plot.png')
...
plt.tight_layout()
rolling_plot_path = os.path.join(directory, 'rolling_statistics_plot.png')
