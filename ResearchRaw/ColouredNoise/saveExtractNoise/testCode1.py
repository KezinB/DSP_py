...
# Save raw audio
folder_path = "C:\\Users\\HP\\OneDrive\\Documents\\Codes\\python\\ResearchRaw\\ColouredNoise\\saveExtractNoise"
now = datetime.now()
folder_name = now.strftime("%Y_%m_%d-%H_%M_%S_recExtractNoiseSave")
