...
class MainWindow(QMainWindow):
    ...
    def setup_file_tab(self):
        ...
        #   Main horizontal layout (Left: Controls | Right: Plot)
        ...
        # Editable Parameters Form Layout
        param_layout = QFormLayout()

        # File Name Display
        self.file_name_label = QLabel("Selected File: None", self)
        self.file_name_label.setStyleSheet(font_style)
        ...
        self.p_wave_prominence = QLineEdit("0.075")
        ...
        # Analyze Button (below parameters)
        ...
        # Right Section: ECG Plot
        self.figure = Figure(figsize=(12, 6))
        self.canvas = FigureCanvas(self.figure)
        plot_layout = QVBoxLayout()
        plot_layout.addWidget(self.canvas)

        # Add Left and Right Sections to Main Content Layout
        content_layout.addLayout(controls_layout, 1)  # Controls take less space
        content_layout.addLayout(plot_layout, 3)  # Plot takes more space
        ...
        self.file_tab.setLayout(main_layout)
    ...
    def process_file(self, file_path):
        ...
        # Update file name label
            self.file_name_label.setText(f"Selected File: {file_path.split('/')[-1]}")
